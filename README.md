...
3. Machine Learning Predictions: A trained classifier predicts diseases based on user-input symptoms.
4. ChatBot Interface: The interface, built with HTML and JavaScript, supports text and image inputs for symptom description.
5. Medical Assistance Recommendations: Critical conditions trigger recommendations for nearby healthcare facilities.
